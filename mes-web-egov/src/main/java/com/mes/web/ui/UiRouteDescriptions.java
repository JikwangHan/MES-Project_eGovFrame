...
public final class UiRouteDescriptions {
    // -------------------------------------------------------------
    // 화면 설명 사전
    // 목적: 각 화면의 목적/입력/검증/데이터소스를 설명한다.
    // 이유: 개발 초기에도 화면 요구사항을 명확히 공유해야 한다.
    // -------------------------------------------------------------
    // 초보자 설명:
    ...
    static {
        ...
        DESCRIPTIONS.put("/ui/main", "메인 화면: MES 홈 진입점. 필수 입력: 없음. 검증: 없음. 데이터 소스(예정): 없음.");
        ...
        // 외부기관 연계
        DESCRIPTIONS.put("/ui/external-sync/logs", "연계 이력 조회: 외부기관 연계 요청 이력을 조회한다. 필수 입력: 없음. 검증: 기간/상태. 데이터 소스(예정): 연계 이력 API.");
    }

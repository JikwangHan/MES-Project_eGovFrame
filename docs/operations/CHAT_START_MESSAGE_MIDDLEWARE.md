# 서비스별 Chat 시작 안내문 (미들웨어)

이 Chat은 미들웨어 전용입니다. 아래 문서를 기준으로 작업합니다.
...
## 2) 미들웨어 전용 통합 가이드(필수)
- docs/operations/SERVICE_CHAT_GUIDE_MIDDLEWARE.md
...
## 4) 초기 작업 범위(고정)
- ai-middleware-egov/ 내 미들웨어 관련 소스만 수정
- mes-common/, mes-contracts/, mes-web-egov/, edge-gateway-egov/ 수정 금지

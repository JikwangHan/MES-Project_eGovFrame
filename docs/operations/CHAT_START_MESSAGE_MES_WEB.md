# 서비스별 Chat 시작 안내문 (MES Web)

이 Chat은 MES Web 전용입니다. 아래 문서를 기준으로 작업합니다.
...
## 2) MES Web 전용 통합 가이드(필수)
- docs/operations/SERVICE_CHAT_GUIDE_MES_WEB.md
...
## 4) 초기 작업 범위(고정)
- mes-web-egov/ 내 MES Web 관련 소스만 수정
- mes-common/, mes-contracts/, ai-middleware-egov/, edge-gateway-egov/ 수정 금지
